...
struct	minix_exec {			/* a.out header */
...
struct minix_nlist {			/* symbol table entry */
...
#define	MINIX_N_SECT		  07	/* section mask */
#define MINIX_N_UNDF		  00	/* undefined */
#define MINIX_N_ABS		  01	/* absolute */
#define MINIX_N_TEXT		  02	/* text */
#define MINIX_N_DATA		  03	/* data */
#define	MINIX_N_BSS		  04	/* bss */
#define MINIX_N_COMM		  05	/* (common) */

/* High bits of storage class. */
#define MINIX_N_CLASS		0370	/* storage class mask */
#define MINIX_C_NULL
#define MINIX_C_EXT		0020	/* external symbol */
#define MINIX_C_STAT		0030	/* static */
